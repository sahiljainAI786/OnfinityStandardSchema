...
namespace VAdvantage.Model
{
    ...
    public class MUser : X_AD_User
    {
        ...
        {
            // net8/headless: the cloud user-sync uses the CloudService WCF client (ServerEndPoint),
            // which is part of the deferred CloudService feature (not available on the headless
            // engine). No-op here; on a Windows build with the Reporting/CloudService assembly this
            // method does the CreateCustomerUserAsync push. See the migration spec (deferred WCF).
        }
