    ...
    public class GenerateXmlForExportData : SvrProcess
    {
       ...
       // string versionId = "1.0.0.0";
        ...
        protected override string DoIt()
        {
            ...
            try
            {
                File.AppendAllText(System.AppDomain.CurrentDomain.BaseDirectory + "\\log\\XMLLog.txt", "DoIT");
                ...
                foreach (ExportDataRecords exportdata in _ExportRecordList)
                {
                    ...
                    File.AppendAllText(System.AppDomain.CurrentDomain.BaseDirectory + "\\log\\XMLLog.txt", "GetFData" + currentTable);
                ...
                _FilePath = Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, prefix, Module_Name.Trim() + "_" + versionNo, "Data");
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    try
                    {
                        ...
                        File.AppendAllText(System.AppDomain.CurrentDomain.BaseDirectory + "\\log\\XMLLog.txt", str);
            ...
            try
            {
                ...
                //if (res.Count() <= 0)
                {
                    ...
                    if (!_ExceptionTables.Contains(tableName))
                    {
                        ...
                        {
                            File.AppendAllText(System.AppDomain.CurrentDomain.BaseDirectory + "\\log\\XMLLog.txt", tableName + " : " + exportdata.Record_ID);
                            int found = 0;
