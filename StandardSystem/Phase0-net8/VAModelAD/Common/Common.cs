                    ...
                    if (ds != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow row in ds.Tables[0].Rows)
                        {
                            hGrid.HeaderItems[Convert.ToInt32(row["SeqNo"])] = new HeaderPanelItemsVO
                            {
                                ...
                                FieldStyleLogic = Convert.ToString(row["StyleLogic"]),
