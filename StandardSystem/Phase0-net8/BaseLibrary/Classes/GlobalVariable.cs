...
namespace VAdvantage.DataBase
{
...

    {
        ...
        public static String AttachmentPath = System.IO.Path.Combine(((string)null) != null
            ? ((string)null) : (AppDomain.CurrentDomain.BaseDirectory.Contains("bin")
        ...
        public static String PhysicalPath = ((string)null) != null
            ? ((string)null) : (AppDomain.CurrentDomain.BaseDirectory.Contains("bin")
            ? AppDomain.CurrentDomain.BaseDirectory.Substring(0, AppDomain.CurrentDomain.BaseDirectory.IndexOf("bin"))
            : AppDomain.CurrentDomain.BaseDirectory);

        public static String ImagePath = System.IO.Path.Combine(((string)null) != null
            ? ((string)null) : (AppDomain.CurrentDomain.BaseDirectory.Contains("bin")
            ? AppDomain.CurrentDomain.BaseDirectory.Substring(0, AppDomain.CurrentDomain.BaseDirectory.IndexOf("bin"))
            : AppDomain.CurrentDomain.BaseDirectory), "Images");

        public static String TempDowloadPath = System.IO.Path.Combine(((string)null) != null
            ? ((string)null) : (AppDomain.CurrentDomain.BaseDirectory.Contains("bin")
            ? AppDomain.CurrentDomain.BaseDirectory.Substring(0, AppDomain.CurrentDomain.BaseDirectory.IndexOf("bin"))
            : AppDomain.CurrentDomain.BaseDirectory), "TempDownload");

        public static String ApplicationPhysicalPath = ((string)null) != null
            ? ((string)null) : (AppDomain.CurrentDomain.BaseDirectory.Contains("bin")
            ? AppDomain.CurrentDomain.BaseDirectory.Substring(0, AppDomain.CurrentDomain.BaseDirectory.IndexOf("bin"))
            : AppDomain.CurrentDomain.BaseDirectory);
