 ...
 * Class Used     : GlobalVariable.cs, VTreeNode(System default)
...
{
    public class VTreeNode : VTreeNodeBase
    {
        ...
        /// </summary>
        /// <param name="node">VTreeNode</param>
        ...
        public VTreeNode(VTreeNode node, bool copyChild)
        {
            ...
            //  VTreeNodeCollection myVTreeNodeCollection = node.Nodes;
            // Create an array of 'TreeNodes'.
            VTreeNode[] myTreeNodeArray = new VTreeNode[node.Nodes.Count];
        ...
        public VTreeNode FindNode(int ID)
        {
            ...
            if (ID == _lastID && _lastNode != null)
                return _lastNode;
            ////
            VTreeNode[] node = this.Nodes.Find(ID.ToString(), true);
    ...
    public class PreorderEnumerator : System.Collections.Generic.IEnumerator<object>
    {
        ...
        public PreorderEnumerator(VTreeNode rootNode)
        {
        ...
        //{
        //    return (stack.Count != 0 && (((VTreeNode)stack.Peek()).Nodes.Count > 0));    //hasMoreElements());
        //}
        ...
        public object Current
        {
            ...
            get
            {
                ...
                VTreeNode node = (VTreeNode)stack.Peek();//
                VTreeNodeCollection nodes = node.Nodes; ;
        ...
        //public VTreeNode NextElement()
        //{
        //    IEnumerator enumer = (IEnumerator)stack.Peek();
        //    VTreeNode node = (VTreeNode)enumer.Current;
