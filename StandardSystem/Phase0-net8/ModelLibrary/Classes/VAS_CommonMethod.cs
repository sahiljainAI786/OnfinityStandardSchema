...
namespace ModelLibrary.Classes
{
    ...
    public class VAS_CommonMethod
    {
        ...
        public static List<FileAttachmentInfo> GetFileBytes(int attachmentID, Ctx ctx)
        {
            ...
            try
            {
                string tempFolderPath = System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "TempDownload");
        ...
        public static void SaveAttachment(List<FileAttachmentInfo> files, int record_ID, int tableID, Ctx ctx)
        {
            ...
            string folderPath = System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "TempDownload");
            ...
            {
                // net8/headless: web AttachmentModel (ViennaAdvantageWeb.Areas.VIS.Models) not
                // available headless; attachment-save skipped (host attaches via MAttachment).
            }
        }
