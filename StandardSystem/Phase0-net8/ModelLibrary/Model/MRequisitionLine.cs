    ...
    public class MRequisitionLine : X_M_RequisitionLine
    {
        ...
        protected override bool BeforeSave(bool newRecord)
        {
            try
            {
                ...
                //VIS383: Bug ID-5698 07/05/24:-Uncheck the "Budget Breach" field when modify requisition line
                if(!newRecord && !IsProcessed() && Util.GetValueOfBool(Get_Value("IsBudgetBreach"))==true)
                {
