...
{
     public class CTreeNode : VAdvantage.Classes.VTreeNode
    { 
    /**
	 *  Construct Model VAdvantage.Classes.VTreeNode
	 *  @param node_ID	node
	...
	public String GetSeqNo()
	{
		...
		if (m_seqNo > 99999)
           // log.Log(Level.SEVERE, "VAdvantage.Classes.VTreeNode Index is higher than 99999");
	...
	public CTreeNode FindNode (int ID)
	{
        ...
        //Enumeration<?> en = preorderEnumeration();
         ////
        VAdvantage.Classes.VTreeNode[] node = this.Nodes.Find(ID.ToString(), true);
