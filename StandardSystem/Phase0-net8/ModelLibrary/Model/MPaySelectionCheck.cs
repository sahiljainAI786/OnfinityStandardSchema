...
namespace VAdvantage.Model
{
    public class MPaySelectionCheck : X_C_PaySelectionCheck
    {
         ...
         */
        public static int ExportToFile(MPaySelectionCheck[] checks, System.IO.FileInfo file)
        {
            ...
            {
                _log.Log(Level.WARNING, "File is directory - " + file.FullName);
                return 0;
            }
            //  delete if exists
            try
            ...
            {
                _log.Log(Level.WARNING, "Could not delete - " + file.FullName, e);
            }
            ...
            try
            {
                System.IO.StreamWriter fw = new System.IO.StreamWriter(file.FullName);
