...
public class X_CM_Container : PO
{
public X_CM_Container (Context ctx, int CM_Container_ID, Trx trxName) : base (ctx, CM_Container_ID, trxName)
{
...
public X_CM_Container (Ctx ctx, int CM_Container_ID, Trx trxName) : base (ctx, CM_Container_ID, trxName)
{
/** if (CM_Container_ID == 0)
{
SetCM_Container_ID (0);
...
*/
public X_CM_Container (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_CM_Container (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_CM_Container (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_CM_Container()
{
...
public static String Table_Name="CM_Container";
...
{
StringBuilder sb = new StringBuilder ("X_CM_Container[").Append(Get_ID()).Append("]");
return sb.ToString();
}
...
Set_Value ("CM_ContainerLink_ID", CM_ContainerLink_ID);
}
/** Get Container Link.
@return Link to another Container in the Web Project */
public int GetCM_ContainerLink_ID() 
{
Object ii = Get_Value("CM_ContainerLink_ID");
if (ii == null) return 0;
