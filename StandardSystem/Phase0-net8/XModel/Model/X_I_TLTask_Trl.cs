...
using System.Data;
/** Generated Model for I_TLTask_Trl
 *  @author Jagmohan Bhatt (generated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
public class X_I_TLTask_Trl : PO
{
public X_I_TLTask_Trl (Context ctx, int I_TLTask_Trl_ID, Trx trxName) : base (ctx, I_TLTask_Trl_ID, trxName)
{
...
public X_I_TLTask_Trl (Ctx ctx, int I_TLTask_Trl_ID, Trx trxName) : base (ctx, I_TLTask_Trl_ID, trxName)
{
/** if (I_TLTask_Trl_ID == 0)
{
SetAD_Task_ID (0);
...
*/
public X_I_TLTask_Trl (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_I_TLTask_Trl (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_I_TLTask_Trl (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_I_TLTask_Trl()
{
 Table_ID = Get_Table_ID(Table_Name);
 model = new KeyNamePair(Table_ID,Table_Name);
}
/** Serial Version No */
//static long serialVersionUID 27638799914183L;
/** Last Updated Timestamp 12/28/2012 11:33:17 AM */
public static long updatedMS = 1356674597394L;
/** AD_Table_ID=1000412 */
public static int Table_ID;
 // =1000412;

/** TableName=I_TLTask_Trl */
public static String Table_Name="I_TLTask_Trl";
...
{
StringBuilder sb = new StringBuilder ("X_I_TLTask_Trl[").Append(Get_ID()).Append("]");
return sb.ToString();
}
/** Set OS Task.
