...
using System.Data;
/** Generated Model for I_TLTab_Trl
 *  @author Jagmohan Bhatt (generated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
public class X_I_TLTab_Trl : PO
{
public X_I_TLTab_Trl (Context ctx, int I_TLTab_Trl_ID, Trx trxName) : base (ctx, I_TLTab_Trl_ID, trxName)
{
/** if (I_TLTab_Trl_ID == 0)
{
SetAD_Tab_ID (0);
...
public X_I_TLTab_Trl (Ctx ctx, int I_TLTab_Trl_ID, Trx trxName) : base (ctx, I_TLTab_Trl_ID, trxName)
{
/** if (I_TLTab_Trl_ID == 0)
{
SetAD_Tab_ID (0);
...
*/
public X_I_TLTab_Trl (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_I_TLTab_Trl (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_I_TLTab_Trl (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_I_TLTab_Trl()
{
...
/** TableName=I_TLTab_Trl */
public static String Table_Name="I_TLTab_Trl";
...
{
StringBuilder sb = new StringBuilder ("X_I_TLTab_Trl[").Append(Get_ID()).Append("]");
return sb.ToString();
}
/** Set Tab.
