...
@return ID/ColumnName pair */
        ...
        }/** Set Budget Breach Percentage.
@param BudgetBreachPercent This field indicates the Percentage of Budget breach.  */
        public void SetBudgetBreachPercent(Decimal? BudgetBreachPercent) { Set_Value("BudgetBreachPercent", (Decimal?)BudgetBreachPercent); }/** Get Budget Breach Percentage.
@return This field indicates the Percentage of Budget breach.  */
        public Decimal GetBudgetBreachPercent() { Object bd = Get_Value("BudgetBreachPercent"); if (bd == null) return Env.ZERO; return Convert.ToDecimal(bd); }
    }
