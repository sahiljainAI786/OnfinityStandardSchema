...
public class X_K_Type : PO
{
public X_K_Type (Context ctx, int K_Type_ID, Trx trxName) : base (ctx, K_Type_ID, trxName)
{
/** if (K_Type_ID == 0)
{
SetIsPublic (true);	// Y
...
public X_K_Type (Ctx ctx, int K_Type_ID, Trx trxName) : base (ctx, K_Type_ID, trxName)
{
/** if (K_Type_ID == 0)
{
SetIsPublic (true);	// Y
...
*/
public X_K_Type (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_K_Type (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_K_Type (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
...
/** Serial Version No */
//static long serialVersionUID 27562514378205L;
/** Last Updated Timestamp 7/29/2010 1:07:41 PM */
public static long updatedMS = 1280389061416L;
/** AD_Table_ID=606 */
public static int Table_ID;
 // =606;

/** TableName=K_Type */
public static String Table_Name="K_Type";
...
{
StringBuilder sb = new StringBuilder ("X_K_Type[").Append(Get_ID()).Append("]");
return sb.ToString();
}
/** Set Description.
