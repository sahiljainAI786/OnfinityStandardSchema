...
{
    public X_C_TargetList(Context ctx, int C_TargetList_ID, Trx trxName)
...
public X_C_TargetList(Ctx ctx, int C_TargetList_ID, Trx trxName)
    : base(ctx, C_TargetList_ID, trxName)
{
/** if (C_TargetList_ID == 0)
{
...
@param trxName transaction
*/
public X_C_TargetList(Ctx ctx, DataRow rs, Trx trxName)
    : base(ctx, rs, trxName)
{
}
/** Load Constructor 
...
@param trxName transaction
*/
public X_C_TargetList(Ctx ctx, IDataReader dr, Trx trxName)
    : base(ctx, dr, trxName)
{
}
/** Static Constructor 
...
/** Serial Version No */
static long serialVersionUID = 27732393089309L;
/** Last Updated Timestamp 12/16/2015 5:39:32 PM */
public static long updatedMS = 1450267772520L;
/** AD_Table_ID=1000240 */
...
/** Set Target List.
@param C_MasterTargetList_ID Target List */
