...
public class X_AD_TreeNodePR : PO
{
public X_AD_TreeNodePR (Context ctx, int AD_TreeNodePR_ID, Trx trxName) : base (ctx, AD_TreeNodePR_ID, trxName)
{
...
public X_AD_TreeNodePR (Ctx ctx, int AD_TreeNodePR_ID, Trx trxName) : base (ctx, AD_TreeNodePR_ID, trxName)
{
/** if (AD_TreeNodePR_ID == 0)
{
SetAD_Tree_ID (0);
...
*/
public X_AD_TreeNodePR (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_AD_TreeNodePR (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_AD_TreeNodePR (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_AD_TreeNodePR()
{
...
public static String Table_Name="AD_TreeNodePR";
...
{
StringBuilder sb = new StringBuilder ("X_AD_TreeNodePR[").Append(Get_ID()).Append("]");
return sb.ToString();
}
/** Set Tree.
