...
@param Color Color */
        public void SetColor(String Color) { if (Color != null && Color.Length > 500) { log.Warning("Length > 500 - truncated"); Color = Color.Substring(0, 500); } Set_Value("Color", Color); }/** Get Color.
@return Color */
