...
// net8: System.Runtime.Remoting removed; legacy TCP-remoting path below is dead code
...
namespace VAdvantage.DataBase
{
    ...
    public class VConnection
    {
        ...
        public Exception TestAppServer()
        {
            ...
            // net8: ChannelServices (Remoting) removed; orphan assignment dropped (was unused)
