...
#pragma warning disable 612, 618
    public class DB
    {
        ...
        public static String TO_DATE(DateTime? time, bool dayOnly)
        {
            if (!dayOnly)
            {
                time = CommonFunctions.SetDateTimeUTC(time);
            }
        ...
        public static DataSet ExecuteDataset(string sql, SqlParameter[] param, Trx trx)
        {
            ...
            {
                return VAdvantage.SqlExec.ExecuteQuery.ExecuteDataset(sql, param);
            }
        }
        ...
        public static DataSet ExecuteDataset(string sql, SqlParameter[] param, Trx trx, int pageSize, int pageNumber)
        {
            ...
            else
            {
                ...
                return VAdvantage.SqlExec.Oracle.OracleHelper.ExecuteDataset(GetConnectionString(), CommandType.Text, ConvertSqlQuery(sql), pageSize, pageNumber, oparam);
        ...
        public static int GetSQLValue(Trx trxName, String sql)
        {
            ...
            try
            {
                ...
                if (idr.Read())
                    retValue = VAdvantage.Utility.Util.GetValueOfInt(idr[0].ToString());
                else
                {
        ...
        public static int GetSQLValue(Trx trxName, String sql, int int_param1)
        {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    retValue = VAdvantage.Utility.Util.GetValueOfInt(dr[0].ToString());
                }
                else
                {
        ...
        public static KeyNamePair[] GetKeyNamePairs(String sql, bool optional)
        {
            ...
            try
            {
                ...
                {
                    list.Add(new KeyNamePair(VAdvantage.Utility.Util.GetValueOfInt(dr[0]), dr[1].ToString()));//.getString(2)));
                }
            }
            catch (Exception e)
            {
        ...
        public static SqlParameter[] ExecuteProcedure(string sql, SqlParameter[] arrParam, Trx trx)
        {
            ...
            {
                return VAdvantage.SqlExec.ExecuteQuery.ExecuteProcedure(sql, arrParam);
            }
        }
