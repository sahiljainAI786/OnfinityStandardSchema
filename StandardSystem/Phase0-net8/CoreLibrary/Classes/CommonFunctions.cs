...
namespace VAdvantage.Classes
{
    public class CommonFunctions
    {
        ...
        public static string GetMachineIPPort()
        {
            ...
            // net8/headless: no HttpContext.Current. Web port must be injected from config by the
            // host (IConfiguration) rather than read from the request. Omitted in the Phase 0 spike.
            return _machineIP;
        }
