...
namespace VAdvantage.Model
{
    public class MMailAttachment1 : X_MailAttachment1
    {
        ...
        private bool SaveLOBData()
        {
            ...
            try
            {
                // net8: standard ZIP (DEFLATE) via System.IO.Compression — format-compatible with
                // the previous java.util.zip output, so existing stored blobs still round-trip.
                using (var zip = new System.IO.Compression.ZipArchive(bOut, System.IO.Compression.ZipArchiveMode.Create, true))
                {
