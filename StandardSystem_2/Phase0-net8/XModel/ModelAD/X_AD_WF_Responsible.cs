namespace VAdvantage.Model
{
    ...
    using System.Data;/** Generated Model for AD_WF_Responsible
 ...
 *  @version Vienna Framework 1.1.1 - $Id$ */
    public class X_AD_WF_Responsible : PO
    {
        ...
        {/** if (AD_WF_Responsible_ID == 0){SetAD_WF_Responsible_ID (0);SetEntityType (null);// U
SetName (null);SetResponsibleType (null);} */
        }
...
*/
        public X_AD_WF_Responsible(Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName) { }/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
        public X_AD_WF_Responsible(Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName) { }/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
        public X_AD_WF_Responsible(Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName) { }/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
        static X_AD_WF_Responsible() { Table_ID = Get_Table_ID(Table_Name); model = new KeyNamePair(Table_ID, Table_Name); }/** Serial Version No */
        static long serialVersionUID = 27888226563429L;/** Last Updated Timestamp 11/23/2020 4:14:07 AM */
        public static long updatedMS = 1606101246640L;/** AD_Table_ID=646 */
        public static int Table_ID; // =646;
...
@return info
*/
        public override String ToString() { StringBuilder sb = new StringBuilder("X_AD_WF_Responsible[").Append(Get_ID()).Append("]"); return sb.ToString(); }/** Set Role.
...
@return Responsibility Role */
        ...
        public static int AD_USER_ID_AD_Reference_ID = 286;/** Set User/Contact.
...
@return User within the system - Internal or Customer/Prospect Contact. */
        public int GetAD_User_ID() { Object ii = Get_Value("AD_User_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set Workflow Incharge.
@param AD_WF_Responsible_ID Responsible for Workflow Execution */
        public void SetAD_WF_Responsible_ID(int AD_WF_Responsible_ID) { if (AD_WF_Responsible_ID < 1) throw new ArgumentException("AD_WF_Responsible_ID is mandatory."); Set_ValueNoCheck("AD_WF_Responsible_ID", AD_WF_Responsible_ID); }/** Get Workflow Incharge.
@return Responsible for Workflow Execution */
        public int GetAD_WF_Responsible_ID() { Object ii = Get_Value("AD_WF_Responsible_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set Custom SQL.
@param CustomSQL Custom SQL */
        public void SetCustomSQL(String CustomSQL) { if (CustomSQL != null && CustomSQL.Length > 2000) { log.Warning("Length > 2000 - truncated"); CustomSQL = CustomSQL.Substring(0, 2000); } Set_Value("CustomSQL", CustomSQL); }/** Get Custom SQL.
@return Custom SQL */
        public String GetCustomSQL() { return (String)Get_Value("CustomSQL"); }/** Set Description.
