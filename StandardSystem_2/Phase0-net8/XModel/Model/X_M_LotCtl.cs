namespace VAdvantage.Model
{
    ...
    public class X_M_LotCtl : PO
    {
        ...
        */
        ...
        /** Set Reference Lot Control Id.
        @param VA007_RefLotCtl_ID Reference Lot Control Id */
        public void SetVA007_RefLotCtl_ID(String VA007_RefLotCtl_ID)
        {
            if (VA007_RefLotCtl_ID != null && VA007_RefLotCtl_ID.Length > 20)
            {
                log.Warning("Length > 20 - truncated");
                VA007_RefLotCtl_ID = VA007_RefLotCtl_ID.Substring(0, 20);
            }
            Set_Value("VA007_RefLotCtl_ID", VA007_RefLotCtl_ID);
        }
        /** Get Reference Lot Control Id.
        @return Reference Lot Control Id */
        public String GetVA007_RefLotCtl_ID()
        {
            return (String)Get_Value("VA007_RefLotCtl_ID");
        }
    }
