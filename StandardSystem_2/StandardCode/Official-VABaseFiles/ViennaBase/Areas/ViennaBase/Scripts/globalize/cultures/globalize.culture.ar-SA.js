...
Globalize.addCultureInfo( "ar-SA", "default", {
    ...
    "Database": "قاعدة البيانات",
	    ...
	    "DatabaseNotFound": "قاعدة البيانات غير موجودة",
	    "UserPwdError": "خطا في كلمة المرور",
	    "RoleNotFound": "صلاحية المستخدم غير موجودة",
	    "Authorized": "مصرح له",
	    "Ok": "نعم",
	    "Cancel": "الغاء",
	    "VersionConflict": "تعارض رقم النسخة",
	    "VersionInfo": "معلومات النسخة",
	    "PleaseUpgrade": "الرجاء القيام بالتحديث",
    //New Resource
	    "Back": "رجوع",
	    ...
	    "VerifyUserLanguage": "تحقق من لغة المستخدم",
