...
public X_M_Replenish(Ctx ctx, int M_Replenish_ID, Trx trxName)
...
*/
public X_M_Replenish(Context ctx, DataRow rs, Trx trxName)
    : base(ctx, rs, trxName)
{
}
/** Load Constructor 
...
@param trxName transaction
*/
public X_M_Replenish(Ctx ctx, DataRow rs, Trx trxName)
    : base(ctx, rs, trxName)
{
}
/** Load Constructor 
...
@param trxName transaction
*/
public X_M_Replenish(Ctx ctx, IDataReader dr, Trx trxName)
    : base(ctx, dr, trxName)
{
}
/** Static Constructor 
...
/** Serial Version No */
static long serialVersionUID = 27725577153844L;
/** Last Updated Timestamp 28/09/2015 20:20:37 */
public static long updatedMS = 1443451837055L;
/** AD_Table_ID=249 */
...
/** Set Min Order Qty.
@param DTD001_MinOrderQty Min Order Qty */
public void SetDTD001_MinOrderQty (Decimal? DTD001_MinOrderQty)
{
Set_Value ("DTD001_MinOrderQty", (Decimal?)DTD001_MinOrderQty);
}
/** Get Min Order Qty.
@return Min Order Qty */
public Decimal GetDTD001_MinOrderQty() 
{
Object bd =Get_Value("DTD001_MinOrderQty");
if (bd == null) return Env.ZERO;
return  Convert.ToDecimal(bd);
}
/** Set Order Pack Qty.
@param DTD001_OrderPackQty Order Pack Qty */
public void SetDTD001_OrderPackQty (Decimal? DTD001_OrderPackQty)
{
Set_Value ("DTD001_OrderPackQty", (Decimal?)DTD001_OrderPackQty);
}
/** Get Order Pack Qty.
@return Order Pack Qty */
public Decimal GetDTD001_OrderPackQty() 
{
Object bd =Get_Value("DTD001_OrderPackQty");
if (bd == null) return Env.ZERO;
return  Convert.ToDecimal(bd);
}
/** Set Export.
